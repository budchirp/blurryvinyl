  ...
  <div className='flex h-min w-full flex-col justify-center gap-1'>
    ...
    <div className='relative flex h-10 w-full items-center rounded-3xl'>
      ...
      <input
        {...props}
        className={cn(
          'bg-background-primary text-text-primary placeholder-text-tertiary border-border focus:border-border-hover hover:border-border-hover flex h-full w-full items-center rounded-3xl border py-2 pl-11 pr-4 transition duration-300',
          className
        )}
      />
    </div>
